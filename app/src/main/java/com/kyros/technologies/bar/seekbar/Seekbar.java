package com.kyros.technologies.bar.seekbar;
 ...
 */
public class Seekbar<T extends Number> extends android.support.v7.widget.AppCompatImageView {
    /**
     * Default color of a {@link Seekbar}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    ...
    public static final int HEIGHT_IN_DP = 380;
...
//        }
    ...
    public interface OnRangeSeekBarChangeListener<T extends Number> {
        ...
        void onRangeSeekBarValuesChanged(Seekbar<T> bar, T minValue, T maxValue);
    }
